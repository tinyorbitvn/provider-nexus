...
type NpmProxyInitParameters struct {
	...
	Replication *NpmProxyReplicationInitParameters `json:"replication,omitempty" tf:"replication,omitempty"`

	// (Attributes) Sonatype Repository Firewall configuration for this Repository.
	RepositoryFirewall *NpmProxyRepositoryFirewallInitParameters `json:"repositoryFirewall,omitempty" tf:"repository_firewall,omitempty"`
...
type NpmProxyObservation struct {
	...
	// (Attributes) Replication configuration for this Repository (see below for nested schema)
	Replication *NpmProxyReplicationObservation `json:"replication,omitempty" tf:"replication,omitempty"`

	// (Attributes) Sonatype Repository Firewall configuration for this Repository.
	RepositoryFirewall *NpmProxyRepositoryFirewallObservation `json:"repositoryFirewall,omitempty" tf:"repository_firewall,omitempty"`
...
type NpmProxyParameters struct {
	...
	// (Attributes) Replication configuration for this Repository (see below for nested schema)
	// +kubebuilder:validation:Optional
	Replication *NpmProxyReplicationParameters `json:"replication,omitempty" tf:"replication,omitempty"`

	// (Attributes) Sonatype Repository Firewall configuration for this Repository.
	// +kubebuilder:validation:Optional
	RepositoryFirewall *NpmProxyRepositoryFirewallParameters `json:"repositoryFirewall,omitempty" tf:"repository_firewall,omitempty"`
...
type NpmProxyReplicationInitParameters struct {
...
type NpmProxyReplicationObservation struct {
...
type NpmProxyReplicationParameters struct {
...
type NpmProxyRepositoryFirewallInitParameters struct {
...
type NpmProxyRepositoryFirewallObservation struct {
...
type NpmProxyRepositoryFirewallParameters struct {
...
// NpmProxy is the Schema for the NpmProxys API. Manage Proxy NPM Repositories.
