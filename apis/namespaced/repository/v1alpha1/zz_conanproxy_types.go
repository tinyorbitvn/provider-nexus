...
type ConanInitParameters struct {

	// (String) Conan protocol version. Cannot be changed once repository is created.
	// Conan protocol version. Cannot be changed once repository is created.
	ConanVersion *string `json:"conanVersion,omitempty" tf:"conan_version,omitempty"`
}

type ConanObservation struct {
...
type ConanParameters struct {

	// (String) Conan protocol version. Cannot be changed once repository is created.
	// Conan protocol version. Cannot be changed once repository is created.
	// +kubebuilder:validation:Optional
	ConanVersion *string `json:"conanVersion" tf:"conan_version,omitempty"`
}
...
type ConanProxyInitParameters struct {
	...
	// (Attributes) Conan Proxy specific configuration for this Repository (see below for nested schema)
	Conan *ConanInitParameters `json:"conan,omitempty" tf:"conan,omitempty"`
	...
	Replication *ConanProxyReplicationInitParameters `json:"replication,omitempty" tf:"replication,omitempty"`

	// (Attributes) Sonatype Repository Firewall configuration for this Repository.
	RepositoryFirewall *ConanProxyRepositoryFirewallInitParameters `json:"repositoryFirewall,omitempty" tf:"repository_firewall,omitempty"`
...
type ConanProxyObservation struct {
	...
	// (Attributes) Conan Proxy specific configuration for this Repository (see below for nested schema)
	Conan *ConanObservation `json:"conan,omitempty" tf:"conan,omitempty"`
	...
	// (Attributes) Replication configuration for this Repository (see below for nested schema)
	Replication *ConanProxyReplicationObservation `json:"replication,omitempty" tf:"replication,omitempty"`

	// (Attributes) Sonatype Repository Firewall configuration for this Repository.
	RepositoryFirewall *ConanProxyRepositoryFirewallObservation `json:"repositoryFirewall,omitempty" tf:"repository_firewall,omitempty"`
...
type ConanProxyParameters struct {
	...
	// (Attributes) Conan Proxy specific configuration for this Repository (see below for nested schema)
	// +kubebuilder:validation:Optional
	Conan *ConanParameters `json:"conan,omitempty" tf:"conan,omitempty"`
	...
	// (Attributes) Replication configuration for this Repository (see below for nested schema)
	// +kubebuilder:validation:Optional
	Replication *ConanProxyReplicationParameters `json:"replication,omitempty" tf:"replication,omitempty"`

	// (Attributes) Sonatype Repository Firewall configuration for this Repository.
	// +kubebuilder:validation:Optional
	RepositoryFirewall *ConanProxyRepositoryFirewallParameters `json:"repositoryFirewall,omitempty" tf:"repository_firewall,omitempty"`
...
type ConanProxyReplicationInitParameters struct {
...
type ConanProxyReplicationObservation struct {
...
type ConanProxyReplicationParameters struct {
...
type ConanProxyRepositoryFirewallInitParameters struct {
...
type ConanProxyRepositoryFirewallObservation struct {
...
type ConanProxyRepositoryFirewallParameters struct {
...
// ConanProxy is the Schema for the ConanProxys API. Manage Proxy CONAN Repositories.
...
type ConanProxy struct {
	...
	// +kubebuilder:validation:XValidation:rule="!('*' in self.managementPolicies || 'Create' in self.managementPolicies || 'Update' in self.managementPolicies) || has(self.forProvider.conan) || (has(self.initProvider) && has(self.initProvider.conan))",message="spec.forProvider.conan is a required parameter"
