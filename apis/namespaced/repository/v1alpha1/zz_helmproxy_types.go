...
type HelmProxyInitParameters struct {
	...
	Replication *HelmProxyReplicationInitParameters `json:"replication,omitempty" tf:"replication,omitempty"`
...
type HelmProxyObservation struct {
	...
	// (Attributes) Replication configuration for this Repository (see below for nested schema)
	Replication *HelmProxyReplicationObservation `json:"replication,omitempty" tf:"replication,omitempty"`
...
type HelmProxyParameters struct {
	...
	// (Attributes) Replication configuration for this Repository (see below for nested schema)
	// +kubebuilder:validation:Optional
	Replication *HelmProxyReplicationParameters `json:"replication,omitempty" tf:"replication,omitempty"`
...
type HelmProxyReplicationInitParameters struct {
...
type HelmProxyReplicationObservation struct {
...
type HelmProxyReplicationParameters struct {
...
// HelmProxy is the Schema for the HelmProxys API. Manage Proxy HELM Repositories.
