...
type CondaProxyInitParameters struct {
	...
	Replication *CondaProxyReplicationInitParameters `json:"replication,omitempty" tf:"replication,omitempty"`

	// (Attributes) Sonatype Repository Firewall configuration for this Repository.
	RepositoryFirewall *CondaProxyRepositoryFirewallInitParameters `json:"repositoryFirewall,omitempty" tf:"repository_firewall,omitempty"`
...
type CondaProxyObservation struct {
	...
	// (Attributes) Replication configuration for this Repository (see below for nested schema)
	Replication *CondaProxyReplicationObservation `json:"replication,omitempty" tf:"replication,omitempty"`

	// (Attributes) Sonatype Repository Firewall configuration for this Repository.
	RepositoryFirewall *CondaProxyRepositoryFirewallObservation `json:"repositoryFirewall,omitempty" tf:"repository_firewall,omitempty"`
...
type CondaProxyParameters struct {
	...
	// (Attributes) Replication configuration for this Repository (see below for nested schema)
	// +kubebuilder:validation:Optional
	Replication *CondaProxyReplicationParameters `json:"replication,omitempty" tf:"replication,omitempty"`

	// (Attributes) Sonatype Repository Firewall configuration for this Repository.
	// +kubebuilder:validation:Optional
	RepositoryFirewall *CondaProxyRepositoryFirewallParameters `json:"repositoryFirewall,omitempty" tf:"repository_firewall,omitempty"`
...
type CondaProxyReplicationInitParameters struct {
...
type CondaProxyReplicationObservation struct {
...
type CondaProxyReplicationParameters struct {
...
type CondaProxyRepositoryFirewallInitParameters struct {
...
type CondaProxyRepositoryFirewallObservation struct {
...
type CondaProxyRepositoryFirewallParameters struct {
...
// CondaProxy is the Schema for the CondaProxys API. Manage Proxy CONDA Repositories.
