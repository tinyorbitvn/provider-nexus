...
type AlpineProxyAlpineInitParameters struct {
...
type AlpineProxyAlpineObservation struct {
...
type AlpineProxyAlpineParameters struct {
...
type AlpineProxyCleanupInitParameters struct {
...
type AlpineProxyCleanupObservation struct {
...
type AlpineProxyCleanupParameters struct {
...
type AlpineProxyInitParameters struct {

	// (Attributes) Alpine specific configuration for this Repository (see below for nested schema)
	Alpine *AlpineProxyAlpineInitParameters `json:"alpine,omitempty" tf:"alpine,omitempty"`

	// (Attributes) Repository Cleanup configuration (see below for nested schema)
	Cleanup *AlpineProxyCleanupInitParameters `json:"cleanup,omitempty" tf:"cleanup,omitempty"`
	...
	RepositoryFirewall *RepositoryFirewallInitParameters `json:"repositoryFirewall,omitempty" tf:"repository_firewall,omitempty"`
	...
	Storage *AlpineProxyStorageInitParameters `json:"storage,omitempty" tf:"storage,omitempty"`
...
type AlpineProxyObservation struct {

	// (Attributes) Alpine specific configuration for this Repository (see below for nested schema)
	Alpine *AlpineProxyAlpineObservation `json:"alpine,omitempty" tf:"alpine,omitempty"`

	// (Attributes) Repository Cleanup configuration (see below for nested schema)
	Cleanup *AlpineProxyCleanupObservation `json:"cleanup,omitempty" tf:"cleanup,omitempty"`
	...
	// (Attributes) Sonatype Repository Firewall configuration for this Repository.
	RepositoryFirewall *RepositoryFirewallObservation `json:"repositoryFirewall,omitempty" tf:"repository_firewall,omitempty"`
	...
	// (Attributes) Storage configuration for this Repository (see below for nested schema)
	Storage *AlpineProxyStorageObservation `json:"storage,omitempty" tf:"storage,omitempty"`
...
type AlpineProxyParameters struct {

	// (Attributes) Alpine specific configuration for this Repository (see below for nested schema)
	// +kubebuilder:validation:Optional
	Alpine *AlpineProxyAlpineParameters `json:"alpine,omitempty" tf:"alpine,omitempty"`

	// (Attributes) Repository Cleanup configuration (see below for nested schema)
	// +kubebuilder:validation:Optional
	Cleanup *AlpineProxyCleanupParameters `json:"cleanup,omitempty" tf:"cleanup,omitempty"`
	...
	// (Attributes) Sonatype Repository Firewall configuration for this Repository.
	// +kubebuilder:validation:Optional
	RepositoryFirewall *RepositoryFirewallParameters `json:"repositoryFirewall,omitempty" tf:"repository_firewall,omitempty"`
	...
	// (Attributes) Storage configuration for this Repository (see below for nested schema)
	// +kubebuilder:validation:Optional
	Storage *AlpineProxyStorageParameters `json:"storage,omitempty" tf:"storage,omitempty"`
...
type AlpineProxyStorageInitParameters struct {
...
type AlpineProxyStorageObservation struct {
...
type AlpineProxyStorageParameters struct {
...
type RepositoryFirewallInitParameters struct {
...
type RepositoryFirewallObservation struct {
...
type RepositoryFirewallParameters struct {
...
// AlpineProxySpec defines the desired state of AlpineProxy
type AlpineProxySpec struct {
	v2.ManagedResourceSpec `json:",inline"`
	ForProvider            AlpineProxyParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider AlpineProxyInitParameters `json:"initProvider,omitempty"`
}

// AlpineProxyStatus defines the observed state of AlpineProxy.
type AlpineProxyStatus struct {
	v2.ManagedResourceStatus `json:",inline"`
	AtProvider               AlpineProxyObservation `json:"atProvider,omitempty"`
}
...
// AlpineProxy is the Schema for the AlpineProxys API. Manage Proxy ALPINE Repositories.
...
type AlpineProxy struct {
	...
	Spec   AlpineProxySpec   `json:"spec"`
	Status AlpineProxyStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// AlpineProxyList contains a list of AlpineProxys
type AlpineProxyList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []AlpineProxy `json:"items"`
}

// Repository type metadata.
var (
	AlpineProxy_Kind             = "AlpineProxy"
	AlpineProxy_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: AlpineProxy_Kind}.String()
	AlpineProxy_KindAPIVersion   = AlpineProxy_Kind + "." + CRDGroupVersion.String()
	AlpineProxy_GroupVersionKind = CRDGroupVersion.WithKind(AlpineProxy_Kind)
)

func init() {
	SchemeBuilder.Register(&AlpineProxy{}, &AlpineProxyList{})
}
