...
type SAMLInitParameters struct {
	...
	// (Boolean) By default, if a signing key is found in the IdP metadata, then Sonatype Nexus Repository Manager will attempt to validate signatures on the assertions.
	...
	// (Boolean) Validate SAML response signature
...
// SAML is the Schema for the SAMLs API. Configure Sonatype Nexus Repository Security SAML.
