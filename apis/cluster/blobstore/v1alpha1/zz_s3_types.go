...
type BucketConfigurationEncryptionInitParameters struct {
	...
	// The encryption key
	EncryptionKeySecretRef *v2.SecretKeySelector `json:"encryptionKeySecretRef,omitempty" tf:"-"`
...
type BucketSecurityInitParameters struct {
	...
	SessionTokenSecretRef *v2.SecretKeySelector `json:"sessionTokenSecretRef,omitempty" tf:"-"`
}
